...
const replaced = ta.replace(oldModal, newModal);
if(replaced === ta) {
  console.log('REPLACEMENT FAILED: String not found');
} else {
  fs.writeFileSync('frontend/src/pages/TrainingAttendance.jsx', replaced, 'utf8');
  console.log('Replaced modal in TrainingAttendance.jsx');
}
